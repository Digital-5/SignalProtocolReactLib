...
async function DR_Init(params) {
    ...
    const dh1 = await (0, CryptoUtils_1.deriveSharedSecret)(ourIdentityKeyPair.privateKey, theirIdentityPublicKey);
    // DH2: Ephemerer Schlüssel für Forward Secrecy
    const dh2 = await (0, CryptoUtils_1.deriveSharedSecret)(ourEphemeralKeyPair.privateKey, theirEphemeralPublicKey);
